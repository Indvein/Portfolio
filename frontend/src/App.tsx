...
import Aurora from "./components/custom/Aurora"; // <-- Imported here
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-[#070707] text-neutral-900 dark:text-neutral-50 font-sans selection:bg-blue-500/30 selection:text-white pb-12 overflow-x-hidden transition-colors duration-500">
      
      {/* --- AURORA BACKGROUND --- */}
      {/* Fixed to the screen, z-0 puts it in back, pointer-events-none lets you click through it */}
      ...
      {/* Added 'relative z-10' here so your content sits ON TOP of the Aurora */}
      <main className="relative z-10 max-w-6xl mx-auto pt-32 px-6">
        <div className="relative flex flex-col md:flex-row items-center justify-between min-h-[85vh] mb-20">
          
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} className="w-full md:w-1/2 z-10 pt-20 md:pt-0 pointer-events-none flex flex-col items-start">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8 pointer-events-auto">
              <a
                href="https://drive.google.com/file/d/1xuY-t0-rfneu7Wot0L7eJUS8OkTKwFDz/view?usp=sharing"
                target="_blank"
                rel="noreferrer"
              ...
              >View Resume</a>
              <a
                href="https://drive.google.com/uc?export=download&id=1xuY-t0-rfneu7Wot0L7eJUS8OkTKwFDz"
          ...
          {/* 3D LANYARD CONTAINER - Now completely hidden on mobile! */}
          <div className="hidden md:flex relative md:w-1/2 md:h-[90vh] z-0 items-center justify-center pointer-events-none">
            <div className="w-full h-full scale-[0.8] md:scale-100 pointer-events-auto cursor-grab active:cursor-grabbing"><Lanyard position={[0, 0, 25]} gravity={[0, -40, 0]} /></div>
          </div>
